...
def read_arguments():
    ...
    parser.add_argument("hierarchy",
                        action="store",
                        help="The name of the hierarchy file")
    parser.add_argument("project_repos",
                        action="store",
                        help="The name of the project repos file")
...
def add_projects(repos, projects_repos, org, name):
    ...
    for repo in repos:
        name = repo.split("https://github.com/")[1].split("/")[1].split(".git")[0].lower()
...
if __name__ == "__main__":
    ...
    project_repos_name = args.project_repos
    project_repos = open_file(project_repos_name, "yml")
    ...
    projects_repos = add_projects(repos, project_repos, org, name)

    write_yaml(project_repos_name, projects_repos)
